...
local Library = Update:Window("Nar","2.0",Enum.KeyCode.RightControl);

Main = Library:Tab("-General-",6026568198)
Sta = Library:Tab("-Stats Player-",7040410130)
Miscf = Library:Tab("-Misc-",9606626859)
Sho = Library:Tab("-Devil Fruit-",7044233235)
